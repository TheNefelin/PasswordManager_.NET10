...
- ✅ **Tests de integración**: 35/35 en total (con BD local y `Auth_Register` actualizado). Casos borde incluidos: login con usuario inexistente (401), password inválida (401), `IsEnableRegister=0` (403), IV con password errónea (401).
